  ...
  template: `
    <div class="container-fluid">
      <form [formGroup]="contactForm" (ngSubmit)="onSend()">
        <div formGroupName="firstLastName">
          ...
          <div class="form-group">
            ...
            <div class="alert alert-danger"
                 *ngIf="LastName.touched &&FirstLastNameGroup.touched && FirstLastNameGroup.invalid">
              <div *ngIf="FirstLastNameGroup.errors.existsContact">FirstName and LastName should be 'lastName &&
                firstName'!
              </div>
            </div>
          </div>
        ...
        <button [disabled]="!contactForm.valid" type="submit" class=" btn btn-primary" *ngIf="contactForm.valid">Send
        </button>
      </form>
